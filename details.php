...
class Module_Order extends Module
{
    ...
    public function install()
    {
        ...
        $namespace = 'streams';
        // Create stream
        $extra = array('title_column' => 'product_code', 'view_options' => array('product_code','product_type','price','promo_price','promo_deadline','collective_price'), 'sorting' => 'title', 'menu_path' => '', 'is_hidden' => 'no');
        ...
        $namespace = 'streams';
        // Create stream
        $extra = array('title_column' => '', 'view_options' => array("user_id","order_status","province","order_total"), 'sorting' => 'title', 'menu_path' => '', 'is_hidden' => 'no');
        ...
        $fields[] = array('name'=>'User ID', 'slug'=>'user_id', 'type'=>'relationship', 'required' => true, 'unique' => false, 'instructions' => '', 'extra'=>array("choose_stream"=>$profile->id, "link_uri"=>null));
        ...
        // $fields[] = array('name'=>'Tryout User', 'slug'=>'user_id', 'type'=>'relationship', 'required' => true, 'unique' => false, 'instructions' => '', 'extra'=>array("choose_stream"=>$profile->id, "link_uri"=>null));
        ...
        $email = array(
            array(
                ...
                'body' => "<p>Terima kasih telah melakukan pemesanan.<br />\nBerikut adalah daftar produk yang Anda pesan: ​</p>\n\n<table border=\"1\" style=\"width: 500px;\">\n    <tbody>\n        <tr>\n            <th>Nama Produk</th>\n            <th>Harga</th>\n            <th>Qty</th>\n            <th>Subtotal</th>\n        </tr>\n{{ produk }}\n        <tr>\n            <td>{{ product_name }}</td>\n            <td>{{ product_price }}</td>\n            <td>{{ qty }}</td>\n            <td>{{ sub_total }}</td>\n        </tr>\n{{ /produk }}\n        <tr>\n            <td colspan=\"3\">Total</td>\n            <td>{{ total }}</td>\n        </tr>\n    </tbody>\n</table>\n\n<p>Silakan kirim sms ke <strong>{{ telepon_konfirmasi }}</strong>, dengan format:</p>\n\n<blockquote>\n<p><strong>Daftar, [Nama], [SMA]</strong><br />\ncontoh: Daftar, Safitri, SMA 1 Pekanbaru</p>\n</blockquote>\n\n<p>Selanjutnya, silakan Anda mentransfer sejumlah <strong>{{ total }}</strong> ke:<br />\n<strong>{{ bank }}</strong><br />\nNo. rekening: <strong>{{ no_rekening }}</strong><br />\na.n. <strong>{{ owner_rek }}</strong></p>\n\n<p>Jika telah mentrasfer, konfirmasi dengan cara sms ke panitia ({{ telepon_konfirmasi }}) dengan format:</p>\n\n<blockquote>\n<p><strong>Sudah transfer sejumlah....., ke Bank Mandiri, tgl transfer....., nama saya.....</strong><br />\ncontoh: sudah transfer sejumlah Rp50.321, ke bank Mandiri, tgl transfer 1 Oktober 2013, nama saya Dita Perdana.</p>\n</blockquote>\n\n<p>Selanjunya kami akan melakukan pengecekan apakah transfer Anda telah kami terima. Dalam waktu 1x24 jam, Anda akan mendapatkan sms konfirmasi dari panitia terkait transfer yang Anda lakukan. Jika transfer Anda sudah kami terima, buku akan kami kirimkan ke alamat Anda / password software akan kami kirimkan ke email Anda / tryout akan kami aktifkan sehingga Anda bisa mengerjakan pada waktu yang telah kami jadwalkan dengan menggunakan username dan password yang telah kami kirim. Informasi ini secara otomatis telah kami kirimkan ke alamat email Anda. Anda bisa melihat informasi ini kembali melalui email Anda.</p>",
                'lang' => 'en',
                'is_default' => 0,
                'module' => 'order'
            ),
            array(
                'slug' => 'notifikasi-pemesanan',
                'name' => 'Notifikasi Pemesanan',
                'description' => 'Email yang dikirim kepada admin ketika ada yang memesan produk',
                'subject' => '{{ settings:site_name }} - Notifikasi Pemesanan',
                'body' => "<p>Seseorang telah memesan produk di {{ settings:site_name }}.<br />\nBerikut adalah daftar produk yang dipesan: ​</p>\n\n<table border=\"1\" style=\"width: 500px;\">\n    <tbody>\n        <tr>\n            <th>Nama Produk</th>\n            <th>Harga</th>\n            <th>Qty</th>\n            <th>Subtotal</th>\n        </tr>\n{{ produk }}\n        <tr>\n            <td>{{ product_name }}</td>\n            <td>{{ product_price }}</td>\n            <td>{{ qty }}</td>\n            <td>{{ sub_total }}</td>\n        </tr>\n{{ /produk }}\n        <tr>\n            <td colspan=\"3\">Total</td>\n            <td>{{ total }}</td>\n        </tr>\n    </tbody>\n</table>\n\n<p>Silakan dicek detail pemesanan di tautan berikut <a href=\"{{ url:site }}admin/order\" target=\"_blank\">Product Order</a>.",
                'lang' => 'en',
                'is_default' => 0,
                'module' => 'order'
            )
